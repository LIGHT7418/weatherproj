...
serve(async (req) => {
  ...
  try {
    ...
    console.log('AI Chat request:', { message, weatherContext });
    ...
    const systemPrompt = `You are a friendly and helpful weather assistant. The user is currently in ${weatherContext.city} where:
